...
Pod::Spec.new do |s|
  ...
  s.dependency 'OTFToolBoxCore', '1.0.2-beta'
  s.dependency 'OTFCloudClientAPI', '1.0.2-beta'
  s.dependency 'OTFTemplateBox', '1.0.2-beta'
  ...
  s.subspec 'Care' do |ss|
    ss.pod_target_xcconfig = {
	  ...
	  ss.dependency 'OTFCloudantStore/CloudantCare', '1.0.2-beta'
	  ss.dependency 'OTFCareKit/Care', '2.0.2-beta.2'
  end
  ...
  s.subspec 'CareHealth' do |ss|
	  ...
	  ss.dependency 'OTFCloudantStore/CloudantCareHealth', '1.0.2-beta'
	  ss.dependency 'OTFCareKit/CareHealth', '2.0.2-beta.2'
  end
end	
