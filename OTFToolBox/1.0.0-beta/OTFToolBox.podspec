...
Pod::Spec.new do |s|
	...
	s.dependency 'OTFCareKit', '2.0.2-beta'
	s.dependency 'OTFCareKitUI', '2.0.2-beta'
	s.dependency 'OTFCareKitStore', '2.0.2-beta'
	s.dependency 'OTFToolBoxCore', '1.0.0-beta'
	s.dependency 'OTFCloudClientAPI', '1.0.0-beta'
	s.dependency 'OTFCloudantStore', '1.0.0-beta'
end	
