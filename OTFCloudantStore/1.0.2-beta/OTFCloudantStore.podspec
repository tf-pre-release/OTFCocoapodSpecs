...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.dependency 'OTFCDTDatastore', '2.1.1-beta.2'
  s.dependency 'OTFCloudClientAPI', '1.0.2-beta'
  ...
  s.subspec 'CloudantOnly' do |ss|
    ...
    ss.dependency 'OTFCDTDatastore', '2.1.1-beta.2'
  end
  ...
  s.subspec 'CloudantCare' do |ss|
    ...
    ss.dependency 'OTFCareKitStore/Care', '2.0.2-beta.2'
    ss.dependency 'OTFCDTDatastore', '2.1.1-beta.2'
    ss.dependency 'OTFResearchKit/Care', '2.0.0-beta.2'
  end
  ...
  s.subspec 'CloudantCareHealth' do |ss|
    ...
    ss.dependency 'OTFCareKitStore/CareHealth', '2.0.2-beta.2'
    ss.dependency 'OTFCDTDatastore', '2.1.1-beta.2'
    ss.dependency 'OTFResearchKit/CareHealth', '2.0.0-beta.2'
  end
