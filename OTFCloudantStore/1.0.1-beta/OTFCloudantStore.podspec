...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.dependency 'OTFCDTDatastore', '2.1.1-beta.1'
  ...
  'SWIFT_ACTIVE_COMPILATION_CONDITIONS' => '$(inherited) CLOUDANT'
   ...
   ss.dependency 'OTFCDTDatastore', '2.1.1-beta.1'
  end
  ...
  s.subspec 'CloudantCare' do |ss|
    ...
    ss.dependency 'OTFCareKitStore/Care', '2.0.2-beta.1'
    ss.dependency 'OTFCDTDatastore', '2.1.1-beta.1'
    ss.dependency 'OTFResearchKit/Care', '2.0.0-beta.1'
  end
  ...
  s.subspec 'CloudantCareHealth' do |ss|
    ...
    ss.dependency 'OTFCareKitStore/CareHealth', '2.0.2-beta.1'
    ss.dependency 'OTFCDTDatastore', '2.1.1-beta.1'
    ss.dependency 'OTFResearchKit/CareHealth', '2.0.0-beta.1'
  end
